...
export const NOTIFICATION_TYPE_META: NotificationTypeMeta[] = [
  ...
  { type: "travel_status_update", label: "ความคืบหน้าคำขอเดินทางของฉัน", description: "แจ้งเมื่อคำสั่งเดินทางของคุณเดินเอกสารแต่ละขั้น (ส่งผอ./ผอ.เซ็น/ส่งคณบดี/คณบดีเซ็น/ส่งมหาวิทยาลัย)", group: "travel" },
...
export const DEFAULT_TYPE_SETTINGS: Record<NotificationType, NotificationTypeSetting> = {
  ...
  travel_status_update:   { type: "travel_status_update",   enabled: true, realtime_enabled: true,  cooldown_seconds: 0,  recipient_roles: ALL_ROLES },
