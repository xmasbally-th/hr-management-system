          ...
          <div className="flex-1">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <Link
                ...
                className="inline-flex items-center gap-2 h-9 px-4 rounded-lg bg-white text-slate-900 text-sm font-semibold hover:bg-slate-100 transition"
              >
                <Check className="h-3.5 w-3.5" /> ตรวจสอบคำขอ ({totalQueue})
              </Link>
              <Link
                href="/dashboard/hr/users"
                className="inline-flex items-center gap-2 h-9 px-4 rounded-lg bg-white/10 border border-white/20 text-white text-sm font-medium hover:bg-white/15 transition"
              >
